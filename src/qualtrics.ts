declare namespace Qualtrics {
  namespace SurveyEngine {
    ...
    class QuestionData {
      ...
      setChoiceAnswerValue(choiceId: string, answerId: string, value: boolean): boolean;
  ...
  interface Selection {
    ...
    SubSelector: string
    ErrorMsg: any
    TerminalAuthError: boolean
    Valid: boolean
    MobileFirst: boolean
    QuestionTypePluginProperties: any
    CurrentMultiPageQuestionIndex: number
    Displayed: boolean
    PreValidation: {
      Settings: {
    ...
    AnswerOrder: string[]
    AnswerTextPosition: string
    ColumnLabels: any
    ColumnLabelsOrder: string[]
    PositionText: string
    RepeatHeaders: string
    WhiteSpace: string
    Stack: boolean
    Selected: any
    IsAutoAuthFailure: boolean
    ErrorSeverity: any
    PDPErrorMsg: any
    PDPError: any
    QuestionText: string
    CustomJS: string
    ExistingChoices: any
    ProcessedDisplayChoiceOrder: string[]
    ChoiceOrderSetup: boolean
    ProcessedDisplayAnswerOrder: string[]
    AnswerOrderSetup: boolean
    Active: boolean
    rowCount: number
    IsResponseSummary: boolean
    WhiteSpacePoint: number
    RedrawHeaderPoint: number
    SeparatorDisplayed: boolean
  }
}
